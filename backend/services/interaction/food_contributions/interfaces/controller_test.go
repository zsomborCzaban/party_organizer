...
func setupFoodContributionController() (domains.IFoodContributionController, *usecases.MockService, *httptest.ResponseRecorder) {
...
func TestFoodContributionController_Create_Success(t *testing.T) {
	controller, service, rr := setupFoodContributionController()
	jwt.GetIdFromJWTFunc = func(string) (uint, error) { return 1, nil }
	service.On("Create", mock.Anything, uint(1)).Return(api.Success(nil))

	body, _ := json.Marshal(domains.FoodContribution{})
...
func TestFoodContributionController_Create_InvalidBody(t *testing.T) {
	controller, _, rr := setupFoodContributionController()
...
func TestFoodContributionController_Create_InvalidJWT(t *testing.T) {
	controller, _, rr := setupFoodContributionController()
...
func TestFoodContributionController_Update_Success(t *testing.T) {
	controller, service, rr := setupFoodContributionController()
	jwt.GetIdFromJWTFunc = func(string) (uint, error) { return 1, nil }
...
func TestFoodContributionController_Update_InvalidBody(t *testing.T) {
	controller, _, rr := setupFoodContributionController()
...
func TestFoodContributionController_Update_InvalidJWT(t *testing.T) {
	controller, _, rr := setupFoodContributionController()
	jwt.GetIdFromJWTFunc = func(string) (uint, error) { return 0, errors.New("invalid") }
...
func TestFoodContributionController_Update_InvalidID(t *testing.T) {
	controller, _, rr := setupFoodContributionController()
	jwt.GetIdFromJWTFunc = func(string) (uint, error) { return 1, nil }
	body, _ := json.Marshal(domains.FoodContribution{})
...
func TestFoodContributionController_Delete_Success(t *testing.T) {
	controller, service, rr := setupFoodContributionController()
	jwt.GetIdFromJWTFunc = func(string) (uint, error) { return 1, nil }
...
func TestFoodContributionController_Delete_InvalidJWT(t *testing.T) {
	controller, _, rr := setupFoodContributionController()
	jwt.GetIdFromJWTFunc = func(string) (uint, error) { return 0, errors.New("invalid") }
...
func TestFoodContributionController_Delete_InvalidID(t *testing.T) {
	controller, _, rr := setupFoodContributionController()
	jwt.GetIdFromJWTFunc = func(string) (uint, error) { return 1, nil }
...
func TestFoodContributionController_GetByPartyIdAndContributorId_Success(t *testing.T) {
	controller, service, rr := setupFoodContributionController()
	jwt.GetIdFromJWTFunc = func(string) (uint, error) { return 1, nil }
...
func TestFoodContributionController_GetByPartyIdAndContributorId_InvalidJWT(t *testing.T) {
	controller, _, rr := setupFoodContributionController()
	jwt.GetIdFromJWTFunc = func(string) (uint, error) { return 0, errors.New("invalid") }
...
func TestFoodContributionController_GetByPartyIdAndContributorId_InvalidPartyID(t *testing.T) {
	controller, _, rr := setupFoodContributionController()
	jwt.GetIdFromJWTFunc = func(string) (uint, error) { return 1, nil }
...
func TestFoodContributionController_GetByPartyIdAndContributorId_InvalidContributorID(t *testing.T) {
	controller, _, rr := setupFoodContributionController()
	jwt.GetIdFromJWTFunc = func(string) (uint, error) { return 1, nil }
...
func TestFoodContributionController_GetByRequirementId_Success(t *testing.T) {
	controller, service, rr := setupFoodContributionController()
	jwt.GetIdFromJWTFunc = func(string) (uint, error) { return 1, nil }
...
func TestFoodContributionController_GetByRequirementId_InvalidJWT(t *testing.T) {
	controller, _, rr := setupFoodContributionController()
	jwt.GetIdFromJWTFunc = func(string) (uint, error) { return 0, errors.New("invalid") }
...
func TestFoodContributionController_GetByRequirementId_InvalidID(t *testing.T) {
	controller, _, rr := setupFoodContributionController()
	jwt.GetIdFromJWTFunc = func(string) (uint, error) { return 1, nil }
...
func TestFoodContributionController_GetByPartyId_Success(t *testing.T) {
	controller, service, rr := setupFoodContributionController()
	jwt.GetIdFromJWTFunc = func(string) (uint, error) { return 1, nil }
...
func TestFoodContributionController_GetByPartyId_InvalidJWT(t *testing.T) {
	controller, _, rr := setupFoodContributionController()
	jwt.GetIdFromJWTFunc = func(string) (uint, error) { return 0, errors.New("invalid") }
...
func TestFoodContributionController_GetByPartyId_InvalidID(t *testing.T) {
	controller, _, rr := setupFoodContributionController()
	jwt.GetIdFromJWTFunc = func(string) (uint, error) { return 1, nil }
