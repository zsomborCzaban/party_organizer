...
func Test_Update_Success(t *testing.T) {
	...
	invitation := domains.PartyInvite{Model: gorm.Model{ID: 1}}
	err := repository.Update(&invitation)
...
func Test_Update_Fail(t *testing.T) {
	...
	partyInvite := domains.PartyInvite{Model: gorm.Model{ID: 1}}
	err := repository.Update(&partyInvite)
